...
#pragma once
#ifndef BSON_STRING_DATA_HPP
#define BSON_STRING_DATA_HPP
...
namespace mongo {
    ...
    */
    ...
    public:
         ...
         * terminator in c.
         */
        StringData( const char* c, std::size_t len )
            : _data(c), _size(len) {}
    ...
    private:
        ...
        const std::size_t    _size;  // 'size' does not include the null terminator
    };

} // namespace mongo

#endif // BSON_STRING_DATA_HPP
